    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 md:px-6 py-12 md:py-24">
        <article className="prose prose-neutral dark:prose-invert max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">1. 7-Day "No Questions Asked" Window</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">2. AI Usage & Abuse Prevention</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">3. Subscription Renewals</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">5. Abuse of Policy</h2>
          <p>

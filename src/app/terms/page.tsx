    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-grow container mx-auto px-4 md:px-6 py-12 md:py-24">
        <article className="prose prose-neutral dark:prose-invert max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4 font-headline">3. Subscriptions & Billing</h2>
          <p>
            All subscriptions and payments are managed by our Merchant of Record. Billing cycles renew automatically unless canceled via your customer portal.
          </p>
